      ...
      <div className="flex-1 p-6 overflow-auto space-y-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button onClick={() => setPayableSheetOpen(true)}>
              Lançar Despesa
            </Button>
            <Button
                ...
                <Card key={d.id} className="p-3">
                  <div className="grid gap-2">
                    <div className="min-w-0">
                      ...
                      <div className="text-sm font-medium truncate" title={contactMap[d.contactId || ""] || d.fornecedor}>
                        {contactMap[d.contactId || ""] || d.fornecedor}
                      </div>
                    </div>
          ...
          <Card className="border-primary ring-1 ring-primary">
            <CardContent className="pt-6">
              <div className="text-sm text-muted-foreground mb-1">
                Total em{" "}
                {selectedMonth
                  ? format(parseISO(selectedMonth + "-01"), "MMMM 'de' yyyy", {
                      locale: ptBR,
                    })
                  : "-"}
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 p-4 text-sm">
              <div className="col-span-1 sm:col-span-2">
                ...
                <div className="font-semibold">
                  {contactsList.find((c) => c.id === selected.contact_id)
                    ?.name || "-"}
                </div>
              </div>
              <div className="col-span-1 sm:col-span-2">
                ...
                <div className="text-lg font-bold">
                  {(selected.amount ?? 0).toLocaleString("pt-BR", {
                    style: "currency",
                    currency: "BRL",
                  })}
                </div>
              ...
              <div>
                ...
                <div>
                  {(selected.interest ?? 0).toLocaleString("pt-BR", {
                    style: "currency",
                    currency: "BRL",
                  })}
                </div>
              ...
              <div>
                ...
                <div>
                  {(selected.fine ?? 0).toLocaleString("pt-BR", {
                    style: "currency",
                    currency: "BRL",
                  })}
                </div>
              ...
              <div>
                ...
                <div>
                  {(selected.discount ?? 0).toLocaleString("pt-BR", {
                    style: "currency",
                    currency: "BRL",
                  })}
                </div>
              ...
              <div>
                ...
                <div>
                  {(selected.total_paid ?? 0).toLocaleString("pt-BR", {
                    style: "currency",
                    currency: "BRL",
                  })}
                </div>
            ...
            <div className="grid grid-cols-2 gap-3 p-4 text-sm">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setEdit({
                      ...edit,
                      status: e.target.value as TransactionInput["status"],
                    })
                  }
                >
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEdit({ ...edit, issue_date: e.target.value })
                  }
                />
              </div>
              <div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setEdit({ ...edit, subcategory_id: e.target.value })
                  }
                >
                  <option value="">Selecione</option>
                  {subcategories.map((s) => (
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setEdit({ ...edit, cost_center_id: e.target.value })
                  }
                >
                  <option value="">Selecione</option>
                  {costCenters.map((cc) => (
          ...
          {mode === "pay" && pay && (
            <div className="grid grid-cols-2 gap-3 p-4 text-sm">
              ...
              <div>
                <div className="text-muted-foreground">Valor Original</div>
                <div>
                  {(pay.amount ?? 0).toLocaleString("pt-BR", {
                    style: "currency",
                    currency: "BRL",
                  })}
                </div>
              ...
              <div>
                ...
                <div className="font-bold text-lg">
                  {(pay.total_paid ?? 0).toLocaleString("pt-BR", {
                    style: "currency",
                    currency: "BRL",
                  })}
                </div>
