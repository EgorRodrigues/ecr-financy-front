      ...
      <div className="flex-1 p-6 overflow-auto space-y-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button onClick={() => setReceivableSheetOpen(true)}>
              Lançar Receita
            </Button>
            <Button
          ...
          {mode === "view" && selected && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 p-4 text-sm">
              <div className="col-span-1 sm:col-span-2">
                ...
                <div>
                  {contactMap[selected.contact_id || ""] ||
                    selected.contact_id ||
                    ""}
                </div>
              </div>
          ...
          {mode === "receive" && receive && (
            <div className="grid grid-cols-2 gap-3 p-4 text-sm">
              ...
              <div>
                ...
                <div>
                  {(receive.amount ?? 0).toLocaleString("pt-BR", {
                    style: "currency",
                    currency: "BRL",
                  })}
                </div>
              ...
              <div>
                ...
                <Input
                  type="date"
                  value={receive.payment_date || ""}
                  onChange={(e) =>
                    setReceive({ ...receive, payment_date: e.target.value })
                  }
                />
              </div>
              <div>
              ...
              <div>
                ...
                <div className="font-bold text-lg">
                  {(receive.total_received ?? 0).toLocaleString("pt-BR", {
                    style: "currency",
                    currency: "BRL",
                  })}
                </div>
