      ...
      <Card className="p-4">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div>
            ...
            <Select
              value={form.tipo}
              onValueChange={(v) => update("tipo", v as Party["tipo"])}
            >
              <SelectTrigger>
          ...
          <div>
            ...
            <Select
              value={form.pessoa}
              onValueChange={(v) => update("pessoa", v as Party["pessoa"])}
            >
              <SelectTrigger>
                <SelectValue placeholder="Selecione" />
              </SelectTrigger>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b">
                <th
                  className="p-2 text-left cursor-pointer hover:bg-muted/50 transition-colors whitespace-nowrap"
                ...
                <th
                  className="p-2 text-left cursor-pointer hover:bg-muted/50 transition-colors whitespace-nowrap"
                  onClick={() => requestSort("displayPersonType")}
                >
                  Pessoa{" "}
                  {sortConfig?.key === "displayPersonType" && (
                    <ArrowUpDown className="ml-2 h-4 w-4 inline" />
                  )}
                </th>
                <th
                ...
                <th
                  className="p-2 text-left cursor-pointer hover:bg-muted/50 transition-colors whitespace-nowrap"
                  onClick={() => requestSort("phone_local")}
                >
                  Telefone{" "}
                  {sortConfig?.key === "phone_local" && (
                    <ArrowUpDown className="ml-2 h-4 w-4 inline" />
                  )}
                </th>
                <th
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 p-4 text-sm">
              <div>
                ...
                <Select
                  value={edit.type}
                  onValueChange={(v) =>
                    setEdit({ ...edit, type: v as ContactInput["type"] })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div>
                ...
                <Select
                  value={edit.person_type}
                  onValueChange={(v) =>
                    setEdit({
                      ...edit,
                      person_type: v as ContactInput["person_type"],
                    })
                  }
                >
                  <SelectTrigger>
              ...
              {edit.person_type === "individual" && (
                <div className="col-span-1 sm:col-span-2">
                  ...
                  <Input
                    ...
                    value={edit.document || ""}
                    onChange={(e) =>
                      setEdit({ ...edit, document: formatCPF(e.target.value) })
                    }
                  />
                </div>
              )}
              {edit.person_type === "company" && (
                <div className="col-span-1 sm:col-span-2">
                  ...
                  <Input
                    ...
                    value={edit.document || ""}
                    onChange={(e) =>
                      setEdit({ ...edit, document: formatCNPJ(e.target.value) })
                    }
                  />
                </div>
              )}
              ...
              <div>
                ...
                <Input
                  inputMode="tel"
                  value={edit.phone_local || ""}
                  onChange={(e) =>
                    setEdit({
                      ...edit,
                      phone_local: formatPhone(e.target.value),
                    })
                  }
                />
              </div>
